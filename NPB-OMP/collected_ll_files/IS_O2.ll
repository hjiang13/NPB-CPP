...
52:                                               ; preds = %43
  %53 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.33, i32 noundef %0, i32 noundef 0)
  br label %57

54:                                               ; preds = %43
  %55 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %56 = add nsw i32 %55, 1
  store i32 %56, ptr @passed_verification, align 4, !tbaa !6
  br label %57

57:                                               ; preds = %1, %52, %54
  %58 = load ptr, ptr @partial_verify_vals, align 8, !tbaa !12
  %59 = getelementptr inbounds i32, ptr %58, i64 1
  %60 = load i32, ptr %59, align 4, !tbaa !6
  %61 = add i32 %60, -1
  %62 = icmp ult i32 %61, 8388607
...
63:                                               ; preds = %57
  ...
  %69 = load i32, ptr getelementptr inbounds ([5 x i32], ptr @test_rank_array, i64 0, i64 1), align 4, !tbaa !6
  %70 = add nsw i32 %38, %69
  %71 = icmp eq i32 %68, %70
  br i1 %71, label %74, label %72

72:                                               ; preds = %63
  %73 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.33, i32 noundef %0, i32 noundef 1)
  br label %77

74:                                               ; preds = %63
  %75 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %76 = add nsw i32 %75, 1
  store i32 %76, ptr @passed_verification, align 4, !tbaa !6
  br label %77

77:                                               ; preds = %57, %72, %74
  %78 = load ptr, ptr @partial_verify_vals, align 8, !tbaa !12
  %79 = getelementptr inbounds i32, ptr %78, i64 2
  %80 = load i32, ptr %79, align 4, !tbaa !6
  %81 = add i32 %80, -1
  %82 = icmp ult i32 %81, 8388607
...
83:                                               ; preds = %77
  ...
  %87 = getelementptr i32, ptr %86, i64 -1
  %88 = load i32, ptr %87, align 4, !tbaa !6
  %89 = load i32, ptr getelementptr inbounds ([5 x i32], ptr @test_rank_array, i64 0, i64 2), align 8, !tbaa !6
  %90 = add nsw i32 %38, %89
  %91 = icmp eq i32 %88, %90
  br i1 %91, label %94, label %92

92:                                               ; preds = %83
  %93 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.33, i32 noundef %0, i32 noundef 2)
  br label %97

94:                                               ; preds = %83
  %95 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %96 = add nsw i32 %95, 1
  store i32 %96, ptr @passed_verification, align 4, !tbaa !6
  br label %97

97:                                               ; preds = %77, %92, %94
  %98 = load ptr, ptr @partial_verify_vals, align 8, !tbaa !12
  %99 = getelementptr inbounds i32, ptr %98, i64 3
  %100 = load i32, ptr %99, align 4, !tbaa !6
  %101 = add i32 %100, -1
  %102 = icmp ult i32 %101, 8388607
...
103:                                              ; preds = %97
  ...
  %109 = load i32, ptr getelementptr inbounds ([5 x i32], ptr @test_rank_array, i64 0, i64 3), align 4, !tbaa !6
  %110 = sub i32 %109, %0
  %111 = add i32 %110, 1
...
113:                                              ; preds = %103
  %114 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %115 = add nsw i32 %114, 1
  store i32 %115, ptr @passed_verification, align 4, !tbaa !6
  br label %119

116:                                              ; preds = %103
  %117 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.33, i32 noundef %0, i32 noundef 3)
  %118 = load ptr, ptr @partial_verify_vals, align 8, !tbaa !12
  br label %119

119:                                              ; preds = %116, %113, %97
  %120 = phi ptr [ %118, %116 ], [ %98, %113 ], [ %98, %97 ]
  %121 = getelementptr inbounds i32, ptr %120, i64 4
  %122 = load i32, ptr %121, align 4, !tbaa !6
  %123 = add i32 %122, -1
  %124 = icmp ult i32 %123, 8388607
...
125:                                              ; preds = %119
  ...
  %131 = load i32, ptr getelementptr inbounds ([5 x i32], ptr @test_rank_array, i64 0, i64 4), align 16, !tbaa !6
  %132 = sub i32 %131, %0
  %133 = add i32 %132, 1
...
135:                                              ; preds = %125
  %136 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.33, i32 noundef %0, i32 noundef 4)
  br label %140

137:                                              ; preds = %125
  %138 = load i32, ptr @passed_verification, align 4, !tbaa !6
  %139 = add nsw i32 %138, 1
  store i32 %139, ptr @passed_verification, align 4, !tbaa !6
  br label %140

140:                                              ; preds = %137, %135, %119
  %141 = icmp eq i32 %0, 10
  br i1 %141, label %142, label %144

142:                                              ; preds = %140
  %143 = load ptr, ptr %2, align 8, !tbaa !12
  store ptr %143, ptr @key_buff_ptr_global, align 8, !tbaa !12
  br label %144
...
248:                                              ; preds = %245
  ...
  %260 = getelementptr ptr, ptr %251, i64 1
  %261 = getelementptr ptr, ptr %251, i64 2
  %262 = getelementptr ptr, ptr %251, i64 3
  br label %263

263:                                              ; preds = %248, %309
  %264 = phi i64 [ 0, %248 ], [ %310, %309 ]
  br i1 %250, label %265, label %309

265:                                              ; preds = %263
  %266 = getelementptr inbounds [1024 x i32], ptr %47, i64 0, i64 %264
  %267 = load i32, ptr %266, align 4, !tbaa !6
  br i1 %258, label %280, label %268

268:                                              ; preds = %265, %268
  %269 = phi i64 [ %277, %268 ], [ %252, %265 ]
  %270 = phi i32 [ %276, %268 ], [ %267, %265 ]
  %271 = phi i32 [ %278, %268 ], [ 0, %265 ]
  %272 = getelementptr inbounds ptr, ptr %251, i64 %269
  %273 = load ptr, ptr %272, align 8, !tbaa !12
  %274 = getelementptr inbounds i32, ptr %273, i64 %264
  %275 = load i32, ptr %274, align 4, !tbaa !6
  %276 = add nsw i32 %270, %275
  store i32 %276, ptr %266, align 4, !tbaa !6
  %277 = add nsw i64 %269, 1
  %278 = add i32 %271, 1
  %279 = icmp eq i32 %278, %257
  br i1 %279, label %280, label %268, !llvm.loop !32

280:                                              ; preds = %268, %265
  %281 = phi i64 [ %252, %265 ], [ %277, %268 ]
  %282 = phi i32 [ %267, %265 ], [ %276, %268 ]
  br i1 %259, label %309, label %283
...
309:                                              ; preds = %280, %283, %263
  %310 = add nuw nsw i64 %264, 1
  %311 = icmp eq i64 %310, 1024
  br i1 %311, label %312, label %263, !llvm.loop !34
